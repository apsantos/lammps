...
double BondBPMRotational::calculate_heat(int type, double Ti, double Tj, double l, double l0)
{
  return Kh[type] * l0 * (Tj - Ti) / l / l;
}

double BondBPMRotational::tempbreak(int type, double Ti, double Tj) 
{
  double Tmax = Ti;
  if (Tj > Tmax) Tmax = Tj;
